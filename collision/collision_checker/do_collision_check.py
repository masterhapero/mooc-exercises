...
#from dt_protocols import (CollisionCheckQuery, CollisionCheckResult, logger, MapDefinition, protocol_collision_checking)
#from collision_drawing_x import plot_geometry
from matplotlib import pyplot
